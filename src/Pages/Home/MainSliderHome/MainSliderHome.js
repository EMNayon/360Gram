    ...
    <div>
      ...
      <div className="grid grid-cols-12">
        <div className="col-span-6 bg-black text-white ">
         ...
         <h2 className=" text-2xl text-white">WELCOME TO CREATIVE AGENCY</h2>
          <br />
          <h2 className="text-6xl text-white py-12 ">
            WE'ARE <br/> DEGITAL <br/> MARKETING <br/> AGENCY
          </h2>
          <Link to='/about-us'>DISCOVER MORE</Link>
         </div>
        </div>
        <div className="absolute transform -translate-y-1/2 left-[650px] top-0" style={divStyle1}></div>
       <div className="absolute bottom-0 left-[-520px] z-20 absolute1"  style={divStyle2}></div>
       <div className="absolute bottom-0 left-[-540px]  absolute1"  style={divStyle3}></div>

        <div className="col-span-6 bg-black text-white" style={Image1}>
        </div>
      </div>
       ...
       <div className="absolute bottom-0 left-[-540px]  absolute1"  style={divStyle3}></div>
        ...
        <div className="col-span-6 bg-black text-white" style={Image2}>
        </div>
      </div>
      ...
      <div className="grid grid-cols-12">
       ...
       <div className="absolute bottom-0 left-[-540px]  absolute1"  style={divStyle3}></div>
        ...
        <div className="col-span-6 bg-black text-white" style={Image3}>
        </div>
      </div> 
      </Carousel>
